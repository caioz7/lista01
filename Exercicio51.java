/**
 * Codigo referente ao Exercício 51 da lista de exercicios(os outros estão apenas no OneDrive).
 * @author Caio Cesar D.
 */
package lista01;
...
public class Exercicio51 extends JFrame implements ActionListener {
	...
	public void Atualizar(){
		JOptionPane.showMessageDialog(null, "Voce selecionou o botao para atualização");
	}
	public void Excluir(){
		JOptionPane.showMessageDialog(null, "Voce selecionou o botao para exclusão");
	}
